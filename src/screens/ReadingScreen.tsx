...
const ReadingScreen: React.FC = ({ navigation }) => {
    ...
    <View key="section1" style={styles.form}>
      ...
      <View style={styles.filtersRow}>
        <View style={styles.filter}>
          ...
          <TouchableOpacity style={styles.datePicker} onPress={() => setShowDatePicker(!currentSection)}>
        ...
        <View style={styles.filter}>
          ...
          <Picker selectedValue={selectedRoute} onValueChange={(itemValue) => handleRouteSelection(itemValue)} style={styles.picker}>
      ...
      <View style={styles.rowGroup}>
        <View style={styles.inputGroupRow}>
          ...
          <TextInput placeholder="Órden de la lectura" style={styles.input} keyboardType="numeric" />
        </View>
        <View style={styles.inputGroupRow}>
          <Text style={styles.inputLabel}>Número de cuenta:</Text>
          <TextInput placeholder="Número de cuenta" style={styles.input} keyboardType="numeric" />
        </View>
      </View>
      <View style={styles.rowGroup}>
        <View style={styles.inputGroupRow}>
          <Text style={styles.inputLabel}>Clave Catastral:</Text>
          <TextInput placeholder="Clave Catastral" style={styles.input} keyboardType="numeric" />
        </View>
        <View style={styles.inputGroupRow}>
          <Text style={styles.inputLabel}>Número de medidor:</Text>
          <TextInput placeholder="Número de medidor" style={styles.input} keyboardType="numeric" />
        </View>
      </View>
      ...
      <View style={styles.rowGroup}>
        <View style={styles.inputGroupRow}>
          ...
          <TextInput placeholder="Lectura inicial" style={styles.input} keyboardType="numeric" />
        </View>
        <View style={styles.inputGroupRow}>
          <Text style={styles.inputLabel}>Lectura actual (m³):</Text>
          <TextInput placeholder="Lectura actual" style={[styles.input, styles.greenInput]} keyboardType="numeric" />
        </View>
      </View>
      <View style={styles.rowGroup}>
        <View style={styles.inputGroupRow}>
          <Text style={styles.inputLabel}>Consumo (m³):</Text>
          <TextInput placeholder="Consumo" style={styles.input} keyboardType="numeric" />
        </View>
        <View style={styles.inputGroupRow}>
          <Text style={styles.inputLabel}>Promedio consumo (m³):</Text>
          <TextInput placeholder="Promedio del consumo" style={styles.input} keyboardType="numeric" />
        </View>
      </View>
    </View>,
    ...
    <View key="section2" style={styles.form}>
      <View style={styles.rowGroup}>
        <View style={styles.inputGroupRow}>
          ...
          <TextInput placeholder="Variación" style={styles.input} keyboardType="numeric" />
        </View>
        <View style={styles.inputGroupRow}>
          <Text style={styles.inputLabel}>Rango de consumo (m³):</Text>
          <TextInput placeholder="Rango" style={styles.input} keyboardType="numeric" />
        </View>
      </View>
      <View style={styles.inputGroup}>
      ...
      <View style={styles.inputGroup}>
        ...
        <TextInput placeholder="Escribe una observación" style={[styles.input, { height: 70, textAlignVertical: 'top' }]} multiline />
      </View>
      <View style={styles.inputGroup}>
      ...
      <View style={styles.inputGroup}>
        ...
        <TextInput value={selectedRoute} editable={false} style={[styles.input, { backgroundColor: '#f2f2f2' }]} />
      </View>
      <View style={styles.inputGroup}>
        <Text style={styles.inputLabel}>Fecha de lectura:</Text>
        <TextInput value={`${date.toLocaleDateString('es-ES')} ${date.toLocaleTimeString('es-ES')}`} editable={false} style={[styles.input, { backgroundColor: '#f2f2f2' }]} />
      </View>
    </View>
  ];
      ...
      <View>
        ...
        {currentSection === 0 && (
          <View style={styles.actionButtons}>
            ...
            <TouchableOpacity style={[styles.arrowButton, styles.saveButton]} onPress={handleSave}>
        ...
        {currentSection < sections.length - 1 && (
          <TouchableOpacity style={styles.arrowButton} onPress={() => setCurrentSection(currentSection + 1)}>
